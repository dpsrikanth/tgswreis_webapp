...
const token = useSelector((state) => state.userappdetails.TOKEN)
      ...
      payload.ZoneId = ZoneId;
          ...
          console.error('Error fetching sent home students list', error)
          setStudents([])
        } finally {
          setLoading(false)
        }
...
const handleExport = () => {
  exportToExcel({
    ...
    sheetName: 'Sent Home Students',
    fileName: 'SentHome_Students',
    title: 'Sent Home Students Report',
    context: contextRows
  })
}
        ...
        <table className="table table-bordered">
          <thead className="table-light">
            <tr>
              ...
              <th>HS Contact</th>
              <th>Student Name</th>
              <th>Sent Home Date</th>
              <th>Parent Name</th>
              <th>Parent Contact</th>
              <th>Remarks</th>
              <th>Family Health Feedback</th>
              <th>Health Status</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
             ...
             filteredStudents.map((s) => (
                <tr key={s.SchoolID}>
                  ...
                  <td>{s.FName}</td>
                  <td>{s.SickGroundContactNo}</td>
                  <td>{s.SickGroundRemarks}</td>
                  <td>{s.SickGroundHomeDate}</td>
                  <td>{s.SickGroundParentName}</td>
                  <td>{s.SickGroundFamilyHealthFeedback}</td>
                  <td>{s.SickGroundHealthStatus}</td>
                </tr>
              ))
            )}
          </tbody>
...
export default StudentsSentHome