...
const SchoolsSickEntered = ({defaultDate}) => {
     ...
     const token = useSelector((state) => state.userappdetails.TOKEN)
      ...
      const fetchSchools = async () => {
        ...
        try {
          ...
          console.error('Error fetching schools entered sick', error)
          setSchools([])
        } finally {
          setLoading(false)
        }
    ...
    const handleExport = () => {
      exportToExcel({
        ...
        sheetName: 'Entered Sick',
        fileName: 'Schools_Entered_Sick',
        title: 'Schools Entered Sick Data',
        context: contextRows
      })
    }
...
export default SchoolsSickEntered