...
const SchoolWiseVendorReleasing = () => {
...
const handleSchoolVendorData = async () => {

    const payload = {
        month: selectedMonth.format("YYYY-MM")
    }

    _fetch('schoolvendorpayments',payload,false,token).then(res => {
...
const exportToExcel = () => {
 ...
 const fromDate = dayjs(new Date(selectedMonth.year(), selectedMonth.month() - 1, 26)).format("DD MMM YYYY");
  ...
  return (
   <>
     <ToastContainer />
    <h6 className="fw-bold mb-3"><a onClick={() => {navigate('/reportsdashboard')}}><i className="bi bi-arrow-left pe-2" style={{fontSize:'24px',verticalAlign:'middle'}}></i></a>School Wise Vendor Releasing</h6>
      
      <div className="row">
        <div className="col-sm-12">
            <div className="white-box shadow-sm">
                <div className="table-header">
                    <h5><span className="pink fw-bold">School Wise Vendor Releasing Amount Report</span></h5>
                </div>
                <div className="row gy-3 align-items-center pt-2">
                   ...
                   <div className='col-sm-6 text-start'>
                    <button className='btn btn-primary mt-4' onClick={handleSchoolVendorData}>Generate</button>
                   </div>
...
export default SchoolWiseVendorReleasing